...
MyHMDControllerDeviceDriver::MyHMDControllerDeviceDriver() {
	...
	else if (headset_type_str == "HP_G2_ASYM") {
		headsetType = HeadsetType::HP_G2_ASYM;
	}
	...
	else if (headset_type_str == "PIMAX_8K_X_NORMAL") {
		headsetType = HeadsetType::PIMAX_8K_X_NORMAL;
	}
	else if (headset_type_str == "PIMAX_8K_X_LARGE") {
		headsetType = HeadsetType::PIMAX_8K_X_LARGE;
	}	
